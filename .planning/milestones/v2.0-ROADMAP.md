...
# Roadmap snapshot (at archive)

## Milestones

- ✅ **v1 MVP** — Phases 1–3 (shipped 2026-09-04) — [archive](./v1-ROADMAP.md) · [requirements](./v1-REQUIREMENTS.md) · [phases](./v1-phases/) · [audit](./v1-MILESTONE-AUDIT.md)
- ✅ **v1.1 Qualidade do exercício** — Phases 4–6 (shipped 2026-09-09) — [archive](./v1.1-ROADMAP.md) · [requirements](./v1.1-REQUIREMENTS.md) · [phases](./v1.1-phases/) · [audit](./v1.1-MILESTONE-AUDIT.md)
- ✅ **v1.2 Ops & Resilience** — Phases 7–10 (shipped 2026-09-15) — [archive](./v1.2-ROADMAP.md) · [requirements](./v1.2-REQUIREMENTS.md) · [phases](./v1.2-phases/) · [audit](./v1.2-MILESTONE-AUDIT.md)
- ✅ **v2.0 Embed em Produção** — Phases 11–12 (shipped 2026-09-18)
