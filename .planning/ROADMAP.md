...
- [ ] **Phase 11: Service Layer Extraction** — Fronteira de embed in-process: lote validado, erros discrimináveis, CLI intacta, env restaurado, encoding/timeout endurecidos
...
|-------|----------------|--------|-----------|
| 11. Service Layer Extraction | 2/3 | In Progress|  |
